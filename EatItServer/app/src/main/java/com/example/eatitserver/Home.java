...
public class Home extends AppCompatActivity
    ...
    public void loadMenu() {
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                Picasso.with(Home.this).load(model.getImage()).into(viewHolder.imageFood);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (item.getTitle().equals(Common.UPDATE)) {
            ...
            Log.d("ABCDEF",adapter.getItem(item.getOrder()).toString() + " - "+adapter.getRef(item.getOrder()).getKey());
    ...
    public void showUpdateDialog(final String key, final Category item) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
    ...
    public void deleteCatagory(String key){
    ...
    private FirebaseRecyclerAdapter<Category, com.example.eatitserver.ViewHolder.MenuViewHolder> adapter;
